                ...
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        @if(session('successMsg'))
                           <span class="success-message" style="width:60%;">{{session('successMsg')}}</span>
                        @elseif(session('errorMsg'))   
                        <span class="error-message" style="width:60%;">{{session('errorMsg')}}</span>
                        @endif


                        @if(session('changedMsg'))
                          <span class="success-message" style="width:60%;">{{session('changedMsg')}}</span>
                       @elseif(session('noChangeMsg'))
                         <span class="error-message" style="width:60%;">{{session('noChangeMsg')}}</span>
                       @elseif(session('missMatchMsg'))  
                         <span class="error-message" style="width:60%;">{{session('missMatchMsg')}}</span>
                       @elseif(session('incorrectMsg'))
                       <span class="error-message" style="width:60%;">{{session('incorrectMsg')}}</span>
                       @endif
                        <a href="">{{$data->name}}</a>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" width="30%" class="text-white" > ID :</th>
                                    <th scope="col">{{rand()."_".$data->id}}</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><input class="form-check-input" type="checkbox"></td>
                                    <td class="text-white">Email Id :</td>
                                    <td>{{$data->email}}</td>
                                    
                                </tr>
                                <tr>
                                    <td><input class="form-check-input" type="checkbox"></td>
                                    <td class="text-white">Phone no. :</td>
                                    <td>{{$data->phone}}</td>
                        ...
                        <a class="btn btn-sm btn-info mt-2" href="admin-edit">Edit</a>
                        &nbsp;
                        <a class="btn btn-sm btn-warning mt-2" href="adminProfileChangepassword">Change Password</a>
                        </div>
                    </div>
