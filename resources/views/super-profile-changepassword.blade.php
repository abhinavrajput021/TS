                ...
                <div class="row p-3" style="background-color:#191C24;">
                        <div class="col-lg-8 col-md-7 col-sm-9 col-xs-9">
                            <h5> Employee Management System </h5>
                                ...
                                <a href="/super-dashboard" class="" style="color: #6C7293;">Home</a> &nbsp; &nbsp;
                  ...
                  <!-- <div class="col-sm-12 col-xl-6"> -->
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            @if(session('missMatchMsg')) 
                                 ...
                                 <span class="error-messagee" style="width:60%;margin-left:2%;"><center>{{session('missMatchMsg')}}</center></span>
                            @elseif(session('incorrectMsg'))
                            
                            <span class="error-messagee" style="width:60%;margin-left:2%;"><center>{{session('incorrectMsg')}}</center></span>
                            @endif
                            </div>
                            <form action="superadminprofilechangepasswordform/{{session('super')}}" method="post">
