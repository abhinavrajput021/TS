        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="super-dashboard" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>SuperPan</h3>
                </a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        ...
                        <a class="btn btn-sm btn-info mt-2" href="super-edit">Edit</a>
                        &nbsp;
                        <a class="btn btn-sm btn-warning mt-2" href="superProfileChangepassword">Change Password</a>
                        </div>
                    </div>
