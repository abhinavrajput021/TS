                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div style="display:flex;">
                                ...
                                @if(session('missMatchMsg')) 
                                    ...
                                    <span class="error-messagee" style="width:60%;margin-left:10%;"><center>{{session('missMatchMsg')}}</center></span>
                                @elseif(session('incorrectMsg'))
                                
                                <span class="error-messagee" style="width:60%;margin-left:10%;"><center>{{session('incorrectMsg')}}</center></span>
                                @endif
                            </div>
                           
                            <form action="adminprofilechangepasswordform/{{session('admin')}}" method="post">
