...
@if(session('super') || session('admin') || session('employee'))
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                                   ...
                                   @elseif(session('admin'))  
                                       ...
                                       <a href="admin-profile" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                                        <div class="nav-item dropdown">
                                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Profile</a>
                                            <div class="dropdown-menu bg-transparent border-0">
                        ...
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                   ...
                                   @if(session('super'))
                                    ...
                                    @elseif(session('employee'))  
                                        <p class="mb-2"><a href="employee-profile">Profile</a></p>    
                                    @endif
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                        ...
                                        @elseif(session('admin'))  
                                           <p class="mb-2"><a href="superList">Show All Super Admin</a></p>
                                        @endif
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">All Employees</h6>

                        @if(session('addedEmployeeMsg'))
                           <span class="success-message" style="width:60%;">{{session('addedEmployeeMsg')}}</span>
                        @elseif(session('faildAEmployeeMsg'))   
                        <span class="error-message" style="width:60%;">{{session('faildAEmployeeMsg')}}</span>
                        @endif


                        @if(session('editedEmployeeMsg'))
                           <span class="success-message" style="width:60%;">{{session('editedEmployeeMsg')}}</span>
                        @elseif(session('notEditEmployeeMsg'))   
                        <span class="error-message" style="width:60%;">{{session('notEditEmployeeMsg')}}</span>
                        @endif

                        

                        @if(session('deletedEmployeenMsg'))
                           <span class="success-message" style="width:60%;">{{session('deletedEmployeenMsg')}}</span>
                        @elseif(session('notDeleteEmployeeMsg'))   
                        <span class="error-message" style="width:60%;">{{session('notDeleteEmployeeMsg')}}</span>
                        @endif
                    ...
                    <div class="table-responsive">
                            ...
                            <tbody>
                               ...
                               @foreach($employees as $employee)
                                <tr>
                                    ...
                                    <td>{{rand(1000,9999)."_".$employee->id}}</td>
                                    <td>{{$employee->name}}</td>
                                    ...
                                    @if(session('employee'))
                                        {{$employee->email}}
                                    @else
                                        <a class="btn btn-sm btn-success" href="{{'editEmployee/'.$employee->id}}">Edit</a>
                                        <a class="btn btn-sm btn-primary" href="{{'deleteEmployee/'.$employee->id}}">Delete</a>
                        ...
                        @else
                           <a class="btn btn-sm btn-warning mt-2" href="addEmployee">Add New Employee</a>
                        @endif
                        </div>
                    </div>
                </div>
