                            ...
                            <tbody>
                               ...
                               @foreach($admins as $admin)
                                <tr>
                                    ...
                                    <a class="" href="{{'editAdmin/'.$admin->id}}"><i class="fa fa-edit" style="color:#659BDF"></i></a>
                                  &nbsp;  <a class="" href="{{'deleteAdmin/'.$admin->id}}"><i class="fa fa-trash" style="color:red"></i></a>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            @foreach($employees as $employee)
                                <tr>
                                    ...
                                    <td>
                                    <a class="" href="{{'editEmployee/'.$employee->id}}"><i class="fa fa-edit" style="color:#659BDF"></i></a>
                                    
                                    
                                    &nbsp;
                                    <a class="" href="{{'deleteEmployee/'.$employee->id}}"><i class="fa fa-trash" style="color:red"></i></a>
                                      </td>
                                </tr>
                                @endforeach
