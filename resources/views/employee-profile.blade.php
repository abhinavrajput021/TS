        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="super-dashboard" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>EmployeePan</h3>
                </a>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2"><a href="adminList">Show All Admins</a></p>
                                <h6 class="mb-0"></h6>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        ...
                        <a class="btn btn-sm btn-info mt-2" href="employee-edit">Edit</a>
                        &nbsp;
                        <a class="btn btn-sm btn-warning mt-2" href="employeeProfileChangepassword">Change Password</a>
                        </div>
                    </div>
